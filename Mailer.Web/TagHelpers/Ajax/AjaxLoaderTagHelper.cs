...
namespace Mailer.Web.TagHelpers.Ajax
{
    /// <summary>
    ...
    public class AjaxLoaderTagHelper : TagHelper
    {
        ...
        public const string AjaxControllerAttributeName = "ajax-controller";
        public const string AjaxActionAttributeName = "ajax-action";
        public const string AjaxRouteAttributeName = "ajax-route";
